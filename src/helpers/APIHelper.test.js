...
describe('APIHelper', () => {
  describe('fetch number of hours', () => {
    ...
    it('throws an error if status code is not ok', async () => {
      ...
      await expect(api.fetchNumberOfHours()).rejects.toEqual(Error('Failed to fetch data'))
    });
  });
  ...
  describe('fetch number of updates', () => {
    ...
    it('throws an error if status code is not ok', async () => {
      ...
      await expect(api.fetchNumberOfUpdates()).rejects.toEqual(Error('Failed to fetch data'))
    });
  });
  ...
  describe('fetch number of contributers', () => {
    ...
    it('throws an error if status code is not ok', async () => {
      ...
      await expect(api.fetchNumberOfContributers()).rejects.toEqual(Error('Failed to fetch data'))
    });
  });
  ...
  describe('fetch lines of code', () => {
    ...
    it('throws an error if status code is not ok', async () => {
      ...
      await expect(api.fetchLinesOfCode()).rejects.toEqual(Error('Failed to fetch data'))
    });
  });
});